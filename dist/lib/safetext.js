...
export const SAFE_TEXT_RULES = [
    {
        ...
        pattern: /<[^\s<>]+@[^\s<>]+>|\b(?:msg|message|thread|draft)[\s._-]?id\b|\b(?=[0-9a-f]{16,}\b)[0-9a-f]*[a-f][0-9a-f]*\b/i,
    ...
    },
    {
        ...
        severity: "refuse",
        pattern: /\b(?:the|this|an?|my|our)\s+agent\b|\bagent[\s_-](?:run|log|draft|note|report|session|state)\b|\b(?:auto|automatically)[- ]?(?:drafted|generated|written)\b|\bdrafted by\b/i,
    ...
    },
    {
        id: "run_report",
        severity: "refuse",
        pattern: /\brun report\b|\b(?:scheduled|overnight|morning|afternoon|nightly)\s+run\b|\bper (?:the|last night's) run\b/i,
 ...
 */
function allowed(matched, allowlist) {
...
export function checkText(value, location, options = {}) {
...
export function checkTexts(targets, options = {}) {
...
//# sourceMappingURL=safetext.js.map