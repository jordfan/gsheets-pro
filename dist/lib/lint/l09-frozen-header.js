 ...
 */
import { boundsA1, firstRowIsBold, frozenRowCount, lintLocation, valueGrid, } from "./types.js";
export const l09FrozenHeader = {
    id: "L09",
    severity: "warning",
    title: "A header row that is not frozen",
    run(ctx) {
        if (frozenRowCount(ctx.sheet) > 0)
            return [];
        ...
        if (tables.length === 0 && !bold && !contractHeader)
            return [];
...
//# sourceMappingURL=l09-frozen-header.js.map